...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_V1_4_TURBO // changed for spot
#endif
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT -1 // changed for spot
 ...
 * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 0 // changed for spot
...
#define CUSTOM_MACHINE_NAME "Spot" // changed for spot
 ...
 */
#define X_DRIVER_TYPE  DRV8825 // changed for spot
#define Y_DRIVER_TYPE  DRV8825 // changed for spot
#define Z_DRIVER_TYPE  DRV8825 // changed for spot
 ...
 */
#define TEMP_SENSOR_0 5 // changed for spot
...
#define HEATER_0_MAXTEMP 290 // changed for spot
#define HEATER_1_MAXTEMP 290 // changed for spot
#define HEATER_2_MAXTEMP 290 // changed for spot
#define HEATER_3_MAXTEMP 290 // changed for spot
#define HEATER_4_MAXTEMP 290 // changed for spot
#define HEATER_5_MAXTEMP 290 // changed for spot
#define HEATER_6_MAXTEMP 290 // changed for spot
#define HEATER_7_MAXTEMP 290 // changed for spot
#define BED_MAXTEMP      110 // changed for spot
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 20.17 // changed for spot
    #define DEFAULT_Ki 3.69 // changed for spot
    #define DEFAULT_Kd 27.56 // changed for spot
  #endif
#else
 ...
 */
#define PIDTEMPBED // changed for spot
  ...
  #define DEFAULT_bedKp 126.87 // changed for spot 
  #define DEFAULT_bedKi 19.36 // changed for spot
  #define DEFAULT_bedKd 554.11 // changed for spot
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 795 } // changed for spot
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 5, 25 } // changed for spot
 ...
 */
#define BLTOUCH // changed for spot
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -20, 0 } // changed for spot
 ...
 */
#define MULTIPLE_PROBING 3 // changed for spot
...
#define INVERT_X_DIR true // changed for spot
...
#define X_BED_SIZE 250 // changed for spot
#define Y_BED_SIZE 250 // changed for spot

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS -24 // changed for spot
#define Y_MIN_POS -17 // changed for spot
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE
#define Y_MAX_POS Y_BED_SIZE
#define Z_MAX_POS 300 // changed for spot 
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
 ...
 */
#define FILAMENT_RUNOUT_SENSOR // changed for spot
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 3 // changed for spot

  #ifdef FILAMENT_RUNOUT_DISTANCE_MM
    // Enable this option to use an encoder disc that toggles the runout pin
    // as the filament moves. (Be sure to set FILAMENT_RUNOUT_DISTANCE_MM
    // large enough to avoid false positives.)
    #define FILAMENT_MOTION_SENSOR // changed for spot
  #endif
#endif
...
#define AUTO_BED_LEVELING_BILINEAR // changed for spot
 ...
 */
#define Z_SAFE_HOMING // changed for spot
 ...
 */
#define EEPROM_SETTINGS   // changed for spot  // Persistent storage with M500 and M501
...
#define PREHEAT_3_LABEL       "PETG" // changed for spot
#define PREHEAT_3_TEMP_HOTEND 235 // changed for spot
#define PREHEAT_3_TEMP_BED     70 // changed for spot
#define PREHEAT_3_TEMP_CHAMBER 35 // changed for spot
#define PREHEAT_3_FAN_SPEED     0 // changed for spot 
 ...
 */
#define NOZZLE_PARK_FEATURE // changed for spot
 ...
 */
#define PRINTCOUNTER // changed for spot
