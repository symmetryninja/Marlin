...
#define STRING_CONFIG_H_AUTHOR "Spidey" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Spike3d 1.4"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 36.88
    #define DEFAULT_Ki 3.62
    #define DEFAULT_Kd 93.95
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 244.89
  #define DEFAULT_bedKi 45.64
  #define DEFAULT_bedKd 875.97
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 795 }
