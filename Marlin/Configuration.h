 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT 1 // changed for spike
 ...
 */
#define BAUDRATE 115200 // changed for spike
 ...
 */
#define X_DRIVER_TYPE  TB6600 // changed for spike
#define Y_DRIVER_TYPE  TB6600 // changed for spike
#define Z_DRIVER_TYPE  TMC2209 // changed for spike
//#define X2_DRIVER_TYPE A4988
//#define Y2_DRIVER_TYPE A4988
#define Z2_DRIVER_TYPE TMC2209 // changed for spike
#define Z3_DRIVER_TYPE TMC2209 // changed for spike
...
#define E0_DRIVER_TYPE TMC2209 // changed for spike
 ...
 */
#define TEMP_SENSOR_0 5 // changed for spike
...
#define HEATER_0_MAXTEMP 300 // changed for spike
#define HEATER_1_MAXTEMP 300 // changed for spike
#define HEATER_2_MAXTEMP 300 // changed for spike
#define HEATER_3_MAXTEMP 300 // changed for spike
#define HEATER_4_MAXTEMP 300 // changed for spike
#define HEATER_5_MAXTEMP 300 // changed for spike
#define HEATER_6_MAXTEMP 300 // changed for spike
#define HEATER_7_MAXTEMP 300 // changed for spike
#define BED_MAXTEMP      110 // changed for spike
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 221.46 // changed for spike
  #define DEFAULT_bedKi 41.94 // changed for spike
  #define DEFAULT_bedKd 779.54 // changed for spike
...
#define EXTRUDE_MINTEMP 150 // changed for spike
...
#define EXTRUDE_MAXLENGTH 900 // changed for spike
...
#define COREXY // changed for spike
//#define COREXZ
//#define COREYZ
//#define COREYX
//#define COREZX
...
// #define ENDSTOPPULLUPS // changed for spike
  ...
  #define ENDSTOPPULLUP_ZMIN_PROBE // changed for spike
#endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 89, 89, 1600, 360.00 } // changed for spike
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 5, 15 } // changed for spike
 ...
 */
#define BLTOUCH // changed for spike
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -30, -15, 2.0 } // changed for spike

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 20 // changed for spike
 ...
 */
#define MULTIPLE_PROBING 3 // changed for spike
...
#define INVERT_X_DIR true // changed for spike
#define INVERT_Y_DIR true
#define INVERT_Z_DIR true // changed for spike
...
#define INVERT_E0_DIR true // changed for spike
...
#define X_BED_SIZE 400 // changed for spike
#define Y_BED_SIZE 400 // changed for spike

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS -32 // changed for spike
#define Y_MIN_POS -7 // changed for spike
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE
#define Y_MAX_POS Y_BED_SIZE
#define Z_MAX_POS 440 // changed for spike
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
 ...
 */
#define FILAMENT_RUNOUT_SENSOR // changed for spike
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 3 // changed for spike

  #ifdef FILAMENT_RUNOUT_DISTANCE_MM
    // Enable this option to use an encoder disc that toggles the runout pin
    // as the filament moves. (Be sure to set FILAMENT_RUNOUT_DISTANCE_MM
    // large enough to avoid false positives.)
    #define FILAMENT_MOTION_SENSOR // changed for spike
  #endif
#endif
...
#define AUTO_BED_LEVELING_BILINEAR // changed for spike
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 4 // changed for spike
 ...
 */
#define Z_SAFE_HOMING // changed for spike
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (15*60) } // changed for spike
 ...
 */
#define EEPROM_SETTINGS     // changed for spike // Persistent storage with M500 and M501
...
#define PREHEAT_3_LABEL       "PETG" // changed for spike
#define PREHEAT_3_TEMP_HOTEND 230 // changed for spike
#define PREHEAT_3_TEMP_BED    65 // changed for spike
#define PREHEAT_3_TEMP_CHAMBER 35 // changed for spike
#define PREHEAT_3_FAN_SPEED     0 // changed for spike
 ...
 */
#define NOZZLE_PARK_FEATURE // changed for spike
 ...
 */
#define PRINTCOUNTER // changed for spike
